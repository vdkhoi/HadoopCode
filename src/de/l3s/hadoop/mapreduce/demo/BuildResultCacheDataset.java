...
public class BuildResultCacheDataset extends Configured implements Tool {
	...
	private static class Map extends
		...
		public void map(LongWritable key, Text value, Context output)
			...
			try {
				...
				String[] fields = rl.split("[\t#:|]");
				output.write(new Text(fields[5]), new Text(fields[7]) );
			} catch (IOException e) {
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(BuildResultCacheDataset.class);
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(),
				new BuildResultCacheDataset(), args);
		System.exit(res);
	}
}