...
public class MappingURL2Id extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		Job job = Job.getInstance(conf, "MappingURL2Id");
		...
		job.setJarByClass(MappingURL2Id.class);
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(), new MappingURL2Id(), args);
		System.exit(res);
	}
}