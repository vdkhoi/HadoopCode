...
public class MappingURL2IdUnarchiveIndexData extends Configured implements Tool {
	public static long offset = 11021309107l;
	...
	private static class Map extends Mapper<LongWritable, Text, LongWritable, Text> {
		...
		public void map(LongWritable key, Text value, Context output)
			...
			try {
				output.write(new LongWritable(key.get() + offset), value);
			} catch (IOException e) {
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(MappingURL2IdUnarchiveIndexData.class);
	...
	public static void main(String[] args) throws Exception {
		...
		int res = ToolRunner.run(new Configuration(), new MappingURL2IdUnarchiveIndexData(), args);
		System.exit(res);
