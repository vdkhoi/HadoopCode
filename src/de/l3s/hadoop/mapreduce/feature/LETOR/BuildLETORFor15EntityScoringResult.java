...
public class BuildLETORFor15EntityScoringResult extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(BuildLETORFor15EntityScoringResult.class);
	...
	public static void main(String[] args) throws Exception {
		...
		int res = ToolRunner.run(new Configuration(), new BuildLETORFor15EntityScoringResult(), args);
		System.exit(res);
