...
public class GenerateHashIDForArchiveURL extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(GenerateHashIDForArchiveURL.class);
	...
	public static void main(String[] args) throws Exception {
		...
		int res = ToolRunner.run(new Configuration(),
				new GenerateHashIDForArchiveURL(), args);
		System.exit(res);
