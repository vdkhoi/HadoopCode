...
//hadoop jar /home/khoi/jars/Temp_SHS-0.0.1-SNAPSHOT-jar-with-dependencies.jar de.l3s.hadoop.mapreduce.graph.ExtractTimeRevision4SHS SHS_graph/graph_adjcency_2013_Jan_time_matrix_SHS_format SHS_graph/graph_adjcency_2013_Jan_time_revisions

public class ExtractTimeRevision4SHS extends Configured implements Tool {
	...
	private static class Reduce extends Reducer<Text, Text, Text, Text> {
		...
		protected void reduce(Text key, Iterable<Text> values, Context output)
			...
			try {
				...
				output.write(key, new Text(values.iterator().next().toString()));
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(),
				new ExtractTimeRevision4SHS(), args);
		System.exit(res);
	}
}