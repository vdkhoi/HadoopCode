...
public class BuildSHSGraphFormat extends Configured implements Tool {
		...
		public void map(LongWritable key, Text value, Context output)
			...
			try {
				if (value != null) {
					...
					Text textKey = new Text(line[0]);
					Text textValue = new Text(line[1]);
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(BuildSHSGraphFormat.class);
